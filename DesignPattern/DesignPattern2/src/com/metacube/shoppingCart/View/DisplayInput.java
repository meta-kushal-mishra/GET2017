...
public class DisplayInput {
	...
	private void editProduct() {
		if (!CartController.getInstance().isCartEmpty()) {
			...
			while (!CartController.getInstance().isProductPresentInCart(productId)) {
			...
			CartController.getInstance().editProductFromCart(productId, quantity);
		} 
		else 
	...
	private void buyProduct() {
		...
		while (!StoreController.getInstance().isValidNumberOfProduct(numberOfProduct)) {
