...
public class CartController {
	...
	public void addProductToCart(int productId, int quantity) {
		DisplayOutput.getInstance().displayOutput(CartFacade.getInstance().addProductToCartByProductId(productId, quantity));
	}
	...
	public void removeProductFromCart(int productId) {
		DisplayOutput.getInstance().displayOutput(CartFacade.getInstance().removeProductFromCartByProductId(productId));
	}
	...
	public void editProductFromCart(int productId, int quantity) {
		DisplayOutput.getInstance().displayOutput(CartFacade.getInstance().editCartProduct(productId, quantity));
	}
	...
	public void generateBill(String name) {
		DisplayOutput.getInstance().displayOutput(BillGeneratorFacade.getInstance().getBill(name));
	}
}
