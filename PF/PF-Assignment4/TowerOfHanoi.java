...
public class TowerOfHanoi {
	...
	private static List<String> mainTowerOfHanoi(String source,  String temp, String destination,
													int numOfDisk, List<String> result,int k) {
	...
	// this method is created according to arguments given in problem
	public static List<String> towerOfHanoi(String source, String destination, String temp, int numOfDisk){
