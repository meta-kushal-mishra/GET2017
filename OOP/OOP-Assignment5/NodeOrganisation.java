...
public class NodeOrganisation extends Node{

	private ProfileOrganisation profile;	//The attributes for the organisation node
	...
	public NodeOrganisation(String name, String place, String type) {
		profile = new ProfileOrganisation(name, place, type);
